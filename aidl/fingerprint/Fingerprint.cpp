...
constexpr FingerprintSensorType SENSOR_TYPE = FingerprintSensorType::UNDER_DISPLAY_OPTICAL;
constexpr bool SUPPORTS_NAVIGATION_GESTURES = true;
constexpr char HW_COMPONENT_ID[] = "goodix_fp";
constexpr char HW_VERSION[] = "";
constexpr char FW_VERSION[] = "";
constexpr char SERIAL_NUMBER[] = "00000001";
constexpr char SW_COMPONENT_ID[] = "";
constexpr char SW_VERSION[] = "";
